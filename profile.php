...
<html lang="en">
  <head>
    ...
    <title>ระบบบันทึกเวลาการทำงาน เขวาทุ่ง 888 *ห้ามเข้าสายนะ จ๊ะ*</title>
  </head>
  <body>
    <div class="container">
      <div class="row">
        <div class="col col-sm-12">
          <h3  class="jumbotron" align="center">ระบบบันทึกเวลาการทำงาน เขวาทุ่ง 888 *ห้ามเข้าสายนะ จ๊ะ* </h3>
        </div>
      </div>
    </div>
    <div class="container">
          ...
          <form action="save.php"  method="post" class="form-horizontal">
            <div class="form-group row">
              ...
              <div class="col col-sm-3">
                ...
                echo '<br><font color="red"> หลัง 16.30 น. </font>';
                } ?>
              </div>
